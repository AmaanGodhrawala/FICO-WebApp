...
class Blockchain:   
    ...
    def __init__(self):
        self.chain = []
        self.transactions = ['Stored Explanations', 'No data yet.', 
        'prev=0', 
        'This page will contain all the features that the initial file will have plus the explanations that will be generated by the modle']
        self.user_list = [0]
...
def explainations():
    ...
    for ind in excelData.index:
        ...
        if((pred_good>0.49 and y==1) or (pred_good<0.49 and y==0)): #correct observation
            count = count +1
...
def mine_block():
    ...
    response = {'message': 'Congratulations, Data is saved!',
                # 'index': block['index'],
                # 'timestamp': block['timestamp'],
                # 'proof': block['proof'],
                # 'previous_hash': block['previous_hash'],
                'user_list': block['user_list'],
                'Text Explanations': block['transactions']
                }
...
def add_transaction():
    if request.method == 'POST':
        ...
        response = {'message': f'To store the data press save'}
...
def global_exp():
    ...
    print(imageList)
    print(imageList)
    return render_template("global_exp.html", len_list = len_list, imageList = imageList)
